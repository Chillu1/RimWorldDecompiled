...
public class RoomContents_SecurityRoom_Reactor : RoomContentsWorker
{
	...
	public override void FillRoom(Map map, LayoutRoom room, Faction faction, float? threatPoints = null)
	{
		...
		SpawnSecurityConsole(map, room);
		base.FillRoom(map, room, faction, threatPoints);
	}

	private static void SpawnSecurityConsole(Map map, LayoutRoom room)
	{
		RoomGenUtility.FillAroundEdges(ThingDefOf.AncientSecurityTerminal, 1, IntRange.One, room, map, ConsoleValidator);
